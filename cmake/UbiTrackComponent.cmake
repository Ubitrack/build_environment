...
macro(ut_create_multi_component)
	foreach(fpath ${UBITRACK_COMPONENT_${the_component}_SOURCES})
	  ...
	  #MESSAGE(STATUS "${the_component} ${UBITRACK_COMPONENT_${the_component}_DEPS} ${UBITRACK_COMPONENT_${the_component}_DEPS_EXT} ${UBITRACK_LINKER_LIBS} ${IPP_LIBS} ${ARGN}")
		...
		install(TARGETS ${fname}
		  RUNTIME DESTINATION ${UBITRACK_COMPONENT_BIN_INSTALL_PATH} COMPONENT libs CONFIGURATIONS Release;RelWithDebInfo
		  LIBRARY DESTINATION ${UBITRACK_COMPONENT_INSTALL_PATH} COMPONENT libs CONFIGURATIONS Release;RelWithDebInfo
		  ARCHIVE DESTINATION ${UBITRACK_COMPONENT_INSTALL_PATH} COMPONENT dev CONFIGURATIONS Release;RelWithDebInfo
		  )
