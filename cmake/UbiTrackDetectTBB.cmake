...
# by Ulrich Eck
if(BUILD_TBB)
  add_subdirectory("${UbiTrack_SOURCE_DIR}/3rdparty/tbb")
  include_directories(SYSTEM ${TBB_INCLUDE_DIRS})
  set(UBITRACK_LINKER_LIBS ${UBITRACK_LINKER_LIBS} tbb)
...
elseif(UNIX AND NOT APPLE)
  ...
  if(TBB_FOUND)
    ...
    set(UBITRACK_LINKER_LIBS ${UBITRACK_LINKER_LIBS} ${TBB_LIBRARIES})
  endif()
endif()
...
if(NOT HAVE_TBB)
  ...
  if(TBB_INCLUDE_DIRS)
    ...
    if(APPLE)
      set(UBITRACK_LINKER_LIBS ${UBITRACK_LINKER_LIBS} libtbb.dylib)
    elseif(ANDROID)
      set(UBITRACK_LINKER_LIBS ${UBITRACK_LINKER_LIBS}  tbb)
