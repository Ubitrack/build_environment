...
find_package( Boost 1.66 COMPONENTS thread date_time system filesystem regex chrono locale serialization program_options REQUIRED)
if(Boost_FOUND)
...
#MSGPACK
IF(WIN32 AND DEFINED EXTERNAL_LIBRARIES_DIR)
    set(MSGPACK_ROOT_DIR "${EXTERNAL_LIBRARIES_DIR}/msgpack")
ENDIF(WIN32 AND DEFINED EXTERNAL_LIBRARIES_DIR)
